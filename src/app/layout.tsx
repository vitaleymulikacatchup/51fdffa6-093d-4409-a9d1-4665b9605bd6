...
export const metadata: Metadata = {
  ...
  description: "Professional photography services specializing in portraits, weddings, and nature photography. Capturing life's beautiful moments with artistic vision and technical excellence.",
  keywords: "photography, professional photographer, portrait photography, wedding photography, nature photography, photo gallery",
  openGraph: {
    title: "PhotoGallery - Professional Photography Services",
    description: "Professional photography services specializing in portraits, weddings, and nature photography. Capturing life's beautiful moments with artistic vision and technical excellence.",
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763371970318-umbi8wyu.jpg",
  ...
  twitter: {
    ...
    title: "PhotoGallery - Professional Photography Services",
    description: "Professional photography services specializing in portraits, weddings, and nature photography.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763371970318-umbi8wyu.jpg"]
  },
  robots: {
    index: true,
    follow: true
